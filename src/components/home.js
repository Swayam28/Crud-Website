  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="text-center mb-20">
        <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Welcome to Cars World</h1>
        <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas odio tempora nostrum quibusdam deleniti consectetur ipsam porro natus obcaecati repellendus, esse vitae culpa ex?</p>
      </div>
